...
public class NewMain {
    ...
    public static void main(String[] args) {
        ...
        cosas.AgregarNodo("Hola");
        cosas.AgregarNodo("Alo");
        cosas.AgregarNodo("Non");
        cosas.AgregarNodo("Yuni");
        cosas.AgregarNodo("Anda");
        cosas.AgregarNodo("Dony");
